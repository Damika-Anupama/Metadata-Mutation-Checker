...
This public repository contains only the self-contained Next.js deployment. The
complete FastAPI + Next.js + Docker implementation and its history are maintained
